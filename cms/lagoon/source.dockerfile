...
RUN rm -fr /app/web/sites/default/files /app/cms/web/sites/default/files

FROM scratch
LABEL org.opencontainers.image.source=https://github.com/danskernesdigitalebibliotek/dpl-web/tree/main/cms
