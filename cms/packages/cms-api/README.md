...
class DefaultApi implements DefaultApiInterface // An interface is autogenerated
{
     ...
     */
    public function campaignMatchPOST(string $format, CampaignMatchPOSTRequest $triggers, int &$responseCode, array &$responseHeaders): array|object|null
    {
...
## Documentation For Models
 ...
 - [CampaignMatchPOSTRequest](docs/Model/CampaignMatchPOSTRequest.md)
 - [CampaignMatchPOSTRequestFacetsInner](docs/Model/CampaignMatchPOSTRequestFacetsInner.md)
 - [CampaignMatchPOSTRequestFacetsInnerValuesInner](docs/Model/CampaignMatchPOSTRequestFacetsInnerValuesInner.md)
 - [CampaignMatchPOSTRequestQueriesInner](docs/Model/CampaignMatchPOSTRequestQueriesInner.md)
