...
/**
 * AgencyBranch Class Doc Comment
 *
 * @category Class
 * @package  DanskernesDigitaleBibliotek\FBS
 * @author   OpenAPI Generator team
 ...
 */
class AgencyBranch implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AgencyBranch';
    ...
    */
     ...
     * Sets branch_id
     *
     * @param string $branch_id ISIL of branch (e.g. DK-761501)
     *
     * @return self
     */
     ...
     * Sets title
     *
     * @param string $title Name of branch
     *
     * @return self
     */
