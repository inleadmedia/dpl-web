 ...
 */
class ParagraphGoVideoBundleVerticalAuto extends \Spawnia\Sailor\ObjectLike
{
    /**
     * @param string $id
    ...
    public static function make(
        ...
        if ($videoAmountOfMaterials !== self::UNDEFINED) {
            $instance->__set('videoAmountOfMaterials', $videoAmountOfMaterials);
        }
        $instance->__typename = 'ParagraphGoVideoBundleVerticalAuto';
    ...
    protected function converters(): array
    {
        ...
        return $converters ??= [
            ...
            'MediaVideotoolVertical' => '\\Drupal\\bnf\\GraphQL\\Operations\\GetNode\\Node\\Paragraphs\\EmbedVideo\\MediaVideotoolVertical',
        ])),
