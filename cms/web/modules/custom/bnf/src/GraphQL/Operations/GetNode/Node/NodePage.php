 ...
 * @property bool|null $displayTitles
 ...
 */
class NodePage extends \Spawnia\Sailor\ObjectLike
{
    /**
     * @param string $id
     * @param string $title
     ...
     * @param bool|null $displayTitles
     * @param string|null $heroTitle
    ...
    public static function make(
        ...
        $created,
        $publicationDate,
        $displayTitles = 'Special default value that allows Sailor to differentiate between explicitly passing null and not passing a value at all.',
        $heroTitle = 'Special default value that allows Sailor to differentiate between explicitly passing null and not passing a value at all.',
        ...
        $instance->__typename = 'NodePage';
        if ($displayTitles !== self::UNDEFINED) {
            $instance->__set('displayTitles', $displayTitles);
        }
    ...
    protected function converters(): array
    {
        ...
        return $converters ??= [
            ...
            'displayTitles' => new \Spawnia\Sailor\Convert\NullConverter(new \Spawnia\Sailor\Convert\BooleanConverter),
            'heroTitle' => new \Spawnia\Sailor\Convert\NullConverter(new \Spawnia\Sailor\Convert\StringConverter),
            ...
            'MediaVideotoolVertical' => '\\Drupal\\bnf\\GraphQL\\Operations\\GetNode\\Node\\TeaserImage\\MediaVideotoolVertical',
        ])),
