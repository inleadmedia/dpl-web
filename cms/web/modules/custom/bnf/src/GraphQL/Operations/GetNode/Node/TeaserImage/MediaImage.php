...
namespace Drupal\bnf\GraphQL\Operations\GetNode\Node\TeaserImage;

/**
 * @property string $id
 * @property string $name
 * @property \Drupal\bnf\GraphQL\Operations\GetNode\Node\TeaserImage\MediaImage\Image $mediaImage
...
class MediaImage extends \Spawnia\Sailor\ObjectLike
{
     ...
     * @param string $id
     * @param string $name
     * @param \Drupal\bnf\GraphQL\Operations\GetNode\Node\TeaserImage\MediaImage\Image $mediaImage
    ...
    protected function converters(): array
    {
        ...
        return $converters ??= [
            ...
            'mediaImage' => new \Spawnia\Sailor\Convert\NonNullConverter(new \Drupal\bnf\GraphQL\Operations\GetNode\Node\TeaserImage\MediaImage\Image),
