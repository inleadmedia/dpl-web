...
class NodeGoArticle extends \Spawnia\Sailor\ObjectLike
{
    ...
    public static function make(
        ...
        if ($teaserImageRequired !== self::UNDEFINED) {
            $instance->__set('teaserImageRequired', $teaserImageRequired);
        }
        ...
        if ($goArticleImage !== self::UNDEFINED) {
            $instance->__set('goArticleImage', $goArticleImage);
        }
    ...
    protected function converters(): array
    {
        ...
        return $converters ??= [
            ...
            'MediaVideotoolVertical' => '\\Drupal\\bnf\\GraphQL\\Operations\\GetNode\\Node\\TeaserImageRequired\\MediaVideotoolVertical',
        ])),
            ...
            'MediaVideotoolVertical' => '\\Drupal\\bnf\\GraphQL\\Operations\\GetNode\\Node\\GoArticleImage\\MediaVideotoolVertical',
        ])),
