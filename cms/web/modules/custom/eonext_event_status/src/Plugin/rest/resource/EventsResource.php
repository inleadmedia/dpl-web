...
namespace Drupal\eonext_event_status\Plugin\rest\resource;
...
use Drupal\dpl_event\Plugin\rest\resource\v1\EventResourceBase;
            ...
            'schema' => [
              ...
              'items' => [
                ...
                'properties' => [
                  ...
                  'ribbon' => [
                    'type' => 'array',
                    'description' => 'The event ribbon color.',
                  ],
                  'description' => [
                    'type' => 'string',
