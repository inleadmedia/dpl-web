...
/**
 * Builds hero variables for the foreninger listing page.
 */
final class ForeningerListingHeroBuilder {
   ...
   *   Hero props or NULL when nothing is configured.
   */
  public function build(?string $default_heading = NULL): ?array {
    $config = $this->configFactory->get('eonext_kultur_branches.settings');
