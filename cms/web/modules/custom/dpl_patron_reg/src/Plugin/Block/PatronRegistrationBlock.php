...
class PatronRegistrationBlock extends BlockBase implements ContainerFactoryPluginInterface {
  ...
  public function build(): array {
    ...
    $data = [
      ...
      'branches-config' => DplReactAppsController::buildBranchesJsonProp($this->branchRepository->getBranches(), TRUE),
      ...
      'address-search-label-text' => $this->t("See libraries near an address", [], ['context' => 'Create patron']),
      'address-search-placeholder-text' => $this->t("Enter an address e.g. Torvegade 1, 1401 København K", [], ['context' => 'Create patron']),
      'address-search-geo-location-button-text' => $this->t("See libraries close to you", [], ['context' => 'Create patron']),
